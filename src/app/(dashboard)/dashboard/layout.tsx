                                ...
                                {sidebarOptions.map((option) => {
                                    ...
                                    return (
                                        <li key={option.id}>
                                            ...
                                            >
                                                <span 
                                                    className='text-gray-400 boder-gray-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium bg-white'
                                                >
